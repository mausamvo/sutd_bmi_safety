"""Train a Gradient Boosting classifier on sEMG feature data."""
...
if os.path.exists("semg_gb.pkl"):
    os.remove("semg_gb.pkl")
    print("Deleted existing semg_gb.pkl")
...
# ── Save ──────────────────────────────────────────────────────────────
joblib.dump(clf, "semg_gb.pkl")
joblib.dump(le, "label_encoder_gb.pkl")
print("Model saved to semg_gb.pkl")
...
print(cm_df)
cm_df.to_csv("confusion_matrix_gb_val.csv")
print("Saved to: confusion_matrix_gb_val.csv")
...
if args.unseen:
    ...
    if not csv_files:
        ...
        if all_unseen_preds:
            ...
            print(agg_cm_df)
            agg_cm_df.to_csv("confusion_matrix_gb_unseen.csv")
            print("Saved to: confusion_matrix_gb_unseen.csv")
