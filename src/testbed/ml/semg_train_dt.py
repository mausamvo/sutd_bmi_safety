"""Train a Decision Tree classifier on sEMG feature data."""
...
if os.path.exists("semg_dt.pkl"):
    os.remove("semg_dt.pkl")
    print("Deleted existing semg_dt.pkl")
...
# ── Save ──────────────────────────────────────────────────────────────
joblib.dump(clf, "semg_dt.pkl")
joblib.dump(le, "label_encoder_dt.pkl")
print("Model saved to semg_dt.pkl")
...
print(cm_df)
cm_df.to_csv("confusion_matrix_dt_val.csv")
print("Saved to: confusion_matrix_dt_val.csv")
...
if args.unseen:
    ...
    if not csv_files:
        ...
        if all_unseen_preds:
            ...
            print(agg_cm_df)
            agg_cm_df.to_csv("confusion_matrix_dt_unseen.csv")
            print("Saved to: confusion_matrix_dt_unseen.csv")
